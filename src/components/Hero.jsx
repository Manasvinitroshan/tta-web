    ...
    <div className='text-white'>
        ...
        <div className='max-w-[1000 px] mt=[-96 px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
            ...
            <div className='flex justify-center items-center'>
                <p className='md:text-2xl sm:text-2xl text-xl font-bold py-4'>A one of its kind fraternity for</p>
                <Typed className='md:text-2xl sm:text-2xl text-xl font-bold pl-2' strings={['profession.','service.','brotherhood.']} typeSpeed={60} backSpeed={70} loop/>
